		...
		<div class="container">
			...
			<div class="well">
				<a id="a-mud" href="/GPSG/construct-web/soil.action"
					class="btn btn-danger btn-lg">剖面位置/土质图</a> <a id="a-facility"
										...
										<div class="modal-body">
											<div class="row">
												<form id="form-loop-query" method="post"
													action="/GPSG/construct-web/excelPartLoop.action"
													class="form-horizontal" role="form">
													<div class="form-group">
														<label class="col-sm-6 control-label" for="excelPath">请输入环号：</label>
														<div class="col-sm-6">
															<input id="excelPath" name="id" value="1" type="text"
																class="form-control">
														</div>
													</div>
													<div class="form-group">
													...
													<div class="modal-footer">
														<button id="btn-by-condition" type="button"
												...
												<form id="form-loop-query1" class="form-inline" role="form">
													<div class="form-group col-sm-9">
														<label class="col-sm-6 control-label"
															for="input-excel-path">请输入EXCEL导出路径：</label>
														<div class="col-sm-6">
															<input id="input-excel-path" name="excelPath"
																value="d:/土质表.xls" type="text" class="form-control">
														</div>
													</div>
													<div class="col-sm-3">
														<button id="excel-export-btn" type="submit"
															class="btn btn-success">导出</button>
													</div>
												</form>
											</div>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form id="form-date-query" method="post"
												action="/GPSG/construct-web/queryDate.action"
												class="form-inline" role="form">
												<div class="form-group col-sm-8">
													<label class="col-sm-5 control-label" for="input-date">测点：</label>
													<div class="col-sm-7">
														<input id="input-date" name="tcCno" type="text"
															class="form-control">
													</div>
												</div>
											</form>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<form id="form-query-by-loop" method="post"
											action="/GPSG/construct-web/queryLoop.action"
											class="form-horizontal" role="form">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal"
													aria-hidden="true">&times;</button>
								...
								-->
									...
									<s:iterator value="#request.soilList" id="soil">
										<tr>
											...
											<td id="nn" class="hide"><s:property value="#soil.tcCy" />
											</td>
											<td id="oo" class="hide"><s:property value="#soil.tcWp" />
											</td>
											<td id="pp" class="hide"><s:property value="#soil.tcWl" />
											</td>
											<td id="qq" class="hide"><s:property value="#soil.tcIl" />
											</td>
							...
							<div class="well">
								<div class="col-sm-offset-4">
									...
									<form id="form-page" method="get"
										action="/GPSG/construct-web/soil.action">
										...
										<s:if test="#page.hasPre">
											<a target="_parent"
												href="soil.action?pageNow=<s:property value="#page.pageNow-1"/>
									">上一页
											</a>
										</s:if>
								...
								">下一页
										...
										<s:if test="#page.hasLast">
											<a target="_parent"
												href="soil.action?pageNow=<s:property value="#page.totalPage"/>
							">尾页
											</a>
										</s:if>
									</form>
